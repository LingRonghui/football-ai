...
class CorrelationsAnalyzerWindow(QDialog):
    ...
    def __init__(self, df: pd.DataFrame):
        ...
        self._feature_types = {'主队': 'home', '客队': 'away'}
    ...
    def _add_widgets(self):
        ...
        form.addRow(QLabel("方法："), self._combo_method)
        ...
        form.addRow(QLabel("球队："), self._combo_feature)
        ...
        form.addRow(QLabel("配色方案："), self._combo_colormap)
    ...
    def _analyze(self):
        ...
        PlotWindow(ax=ax, parent=self, title='相关性分析').show()
