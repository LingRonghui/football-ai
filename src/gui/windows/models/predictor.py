...
class PredictorDialog(QDialog):
    ...
    def _add_widgets(self):
        ...
        teams_hbox.addWidget(QLabel(text='主队'))
        ...
        teams_hbox.addWidget(QLabel(text='客队'))
        ...
        self._edit_home_odd.setPlaceholderText('主队赔率...')
        ...
        self._edit_draw_odd.setPlaceholderText('平局赔率...')
    ...
    def _predict(self):
        ...
        SimpleTableDialog(df=match_df, parent=self, title='预测结果', readonly=False).show()
    ...
    def _validate_inputs(self) -> bool:
        ...
        for odd in odds:
            try:
                ...
                QMessageBox.critical(self, '赔率无效', f'赔率 "{odd}" 不是数字。')
                return False
            else:
                if odd <= 1.0:
                    QMessageBox.critical(self, '赔率无效', f'赔率不能小于 1.00，当前为 "{odd}"。')
                    return False
        return True
